...
<head>
    ...
    <link href='https://unpkg.com/boxicons@2.1.4/css/boxicons.min.css' rel='stylesheet'>    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.6/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-4Q6Gf2aSP4eDXB8Miphtr37CMZZQ5oXLH2yaXMJ2w8e2ZtHTl7GptT4jmndRuHDT" crossorigin="anonymous">
...
<div class="container-fluid">
  ...
  <div class="dropdown">
    <button class="btn btn-warning dropdown-toggle text-white" type="button" id="fashionDropdown" data-bs-toggle="dropdown" aria-expanded="false">
      Fashion
    </button>
  ...
  <div class="dropdown">
    <button class="btn btn-warning dropdown-toggle text-white" type="button" id="electronicsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
      Electronics
    </button>
  ...
  <div class="dropdown">
  <button class="btn btn-warning dropdown-toggle text-white" type="button" id="groceryDropdown" data-bs-toggle="dropdown" aria-expanded="false">
  Grocery Products
</button>
<ul class="dropdown-menu" aria-labelledby="groceryDropdown">
  ...
  <li><a class="dropdown-item" href="#">Cold drinks</a></li>
        ...
        <!-- </li> -->
        <!-- <li class="nav-item">
          <a class="nav-link text-white btn btn-secondary dropdown-toggle" aria-disabled="true">Electronics</a>
    ...
    <a href="#" class="color-white text-white fs-6 text-decoration-none"><i class='bx bx-user-circle'></i>Login</a>
